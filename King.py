#Script Given By RASHED CODER

#Script Is Given For Educational Purpose

#Script Edited By @Rashed-Hacker
...
def crack_select():
    ...
    print ' \x1b[1;94m  Wait Ids Will Appear Here \033[0m'#Thanks King-Rashed
...
print "\033[1;96m[!] \x1b[1;91mExit"
    ...
    print '   \x1b[0m Total Ok / Cp ids : ' + str(len(oks)) + '/' + str(len(cps)) ##Thanks king-Rashed
